...
class MAP:
    def __init__(self, labels, alpha=None, verbose=False):
...
def cluster_data_and_labels(active_data, active_data_afsl, active_labels, random=1, n_clusters=10, samples_per_cluster=2, random_state=42):
...
if __name__ == '__main__':
    ...
    model = GaussianModel(n_ways, lam, active_ndatas, active_nlabels)
    model.initFromLabelledDatas(mus)
    optim = MAP(active_nlabels, alpha=alpha, verbose=verbose)
